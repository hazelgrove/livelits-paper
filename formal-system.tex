...
\vskip 0.5cm
Well-formed context principle: In the following, any instance of a palette context (e.g. $\pPhi$) is taken
to be "well-formed", in the sense that:
\\
For all $\rho : \pDefRecordF{\eexpand}{\tmodel}{\tsplice}{\texpansion} \in \pPhi$,
$\hana{\EmptyhGamma}{\eexpand}{\tarr{\tmodel}{\tarr{\tsplice}{\texpansion}}}$.
\\
The rules enforce the inductive case of this principle.
\begin{mathpar}
\\\\
\inferrule[SPELetPal]{
