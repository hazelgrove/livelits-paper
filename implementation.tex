...
it was natural to choose the the Hazel programming environment for our primary implementation\todo{cite?}{}. 
...
Hazel is implemented in OCaml and compiled to JavaScript using the \li{js_of_ocaml} compiler\todo{cite}.
...
based on the work of Bernardy et al \todo{cite bernardy}. This system relies 
