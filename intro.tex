...
\begin{enumerate}
  ...
  For example, the \li{\$slider} livelit in Fig.~\ref{fig:color}(b) is parameterized by the lower and upper bound. 
  ...
  that operates as a \li{\$slider} from \li{0} to \li{100} by abbreviation:
  \begin{lstlisting}[numbers=none]
