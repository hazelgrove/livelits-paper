...
Our focus in this paper is on addressing a number of non-trivial technical 
...
\begin{enumerate}
  ...
  \item \textbf{Decentralized Extensibility}: 
    ...
    e.g. \li{\$color} and \li{\$slider} in Fig.~\ref{fig:color}(b), to distinguish
  ...
  Fig.~\ref{fig:color}(b) demonstrates splicing: the client defines a variable, \li{grayLevel}, 
  for each of the red, green, and blue components, and places a slider inline in the splice governing 
  the alpha (A) component. In Sec.~X\todo{section}{}, we will see more sophisticated examples.
