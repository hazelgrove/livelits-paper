...
\newcommand{\pexpPalAp}[5]{#2\,\keyword{as palette}\,#1\,\keyword{where}\,\fmap{#3}{#5}{#4}}
\newcommand{\encExp}{Exp} % Whatever htyp encoded things should have
...
\newcommand{\decode}[2]{#1 \Uparrow #2}
...
\newcommand{\downArrowsTo}[2]{#1 \Downarrow #2}
