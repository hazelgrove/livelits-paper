...
For example, the closure around the application of \li{\$dataframe} in Fig.~\ref{fig:grading}
contains the value of the \li{weights} variable from Line 1 and any other bound variables, e.g. 
...
The closure for the \li{\$cutoffs} livelit in Fig.~\ref{fig:grading} includes a binding for 
the \li{grades} variable. However, this variable's evaluation result, along with the evaluation 
