...
\begin{figure*}
  \begin{minipage}[t]{0.38\textwidth}
    ...
    \begin{snugshade}
     ...
     \end{snugshade}
      ...
      \Description{A reproduction of a Graphite color palette appearing as a pop above Java code where the cursor is in a hole of type \li{Color}.}
      \vspace*{-5mm}
    \end{subfigure}
    \hspace{8mm}
    \begin{subfigure}[t]{\linewidth}
    ...
    \label{fig:color}
     ...
     \end{snugshade}
      ...
      \Description{An application of the \li{\$color} livelit to compute a shade of green as described in the text.}
    \end{subfigure}
  \end{minipage}
  \hspace{10.5mm}
  ...
  \begin{snugshade}
   \vspace*{-2mm}
    ...
    \Description{A case study involving several livelits which are described in the text.}
  \end{subfigure}
  \vspace{-5mm}
...
\newcommand{\llproperty}[1]{\vspace{5px plus 5px minus 3px}\noindent\textbf{#1}.}
