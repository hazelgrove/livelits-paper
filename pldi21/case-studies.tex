...
\li{\$slider}.
The table itself displays not the expression itself but rather its value, \li{80.}, just as in a spreadsheet.
...
\begin{figure*}
  \begin{center}
    ...
    \Description{Two screenshots of the same Hazel program but with a different closure selected for the livelit. This causes the livelit to display a different image, as the image URL differs in the two closures.}
