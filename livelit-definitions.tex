...
Talk about how you can use livelits inside the view function, e.g. livelits for GUI widgets.

Stylesheet namespace isolation mechanism? (implementation section?)
